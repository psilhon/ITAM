...
import { advancedImportController } from '../controllers/advanced-import.controller'
...
// 获取资产归属列表（用于过滤下拉，支持按公司筛选）
router.get('/meta/owners', serverController.getOwners)
...
// 批量导入多个资产文件（支持同时上传多个文件）
router.post('/batch-import', advancedImportController.batchImportServers)
